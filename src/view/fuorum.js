        ...
        <section class="profileInformation">
            <div>
                ...
                <div class="personalInformationPerfilUser">
                    <div class="namePerfilUser" id="nombreUsuario"><strong class="black-text perfilName little" id="email">
                    ${user.email}
                    <i class="material-icons center editProfileIcon">edit</i></strong></div>
                    <div class="professionDescription" id="profesionUser">Developer Sr. en Accenture</div>
                </div>
            </div>
        </section>
        <form>
