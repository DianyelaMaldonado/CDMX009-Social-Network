        ...
        <section id="esther">
            <main>
                ...
                <form action="" class="form">
                    ...
                    <input type="email" class="validate user boxEmail" required="" aria-required="true" placeholder="Usuario" id="email">
                </label>
                    ...
                    <button id="doLogin" type="submit" class="waves-effect waves-light btn-small btn-login" onclkck='getData()'>Login</button>
